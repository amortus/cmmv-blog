                                    ...
                                    <header class="post-header my-6">
                                        <div class="post-meta flex items-center">
                                            ...
                                            <div class="post-status ml-4" v-if="post.status !== 'published'">
                                                <span class="bg-[#fbbf24] text-[#333333] px-2 py-1 rounded-full text-xs font-semibold">{{ post.status?.toUpperCase() }}</span>
                                            </div>
                                        </div>
                                    </header>
                                    ...
                                    <div v-if="author"
                                        ...
                                        <div class="flex items-center mb-4">
                                            ...
                                            <div
                                                ...
                                                <div v-else
                                                    class="w-full h-full flex items-center justify-center bg-[#0891b2] text-white font-bold text-lg">
                                                    {{ authorInitials }}
                                                </div>
                                            </div>
