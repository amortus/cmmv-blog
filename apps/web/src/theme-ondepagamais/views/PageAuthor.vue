        ...
        <div class="lg:max-w-4xl md:max-w-3xl px-4 sm:px-6 mx-auto py-8">
            ...
            <div v-else>
                ...
                <h2 class="text-xl font-bold text-neutral-900 mb-6 pb-2 border-b border-neutral-200 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#0891b2]" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div v-for="post in (authorPosts.posts || authorPosts)" :key="post.id"
                            ...
                            <div class="flex items-center p-4 border-b border-neutral-100">
                                <div class="w-10 h-10 rounded-full overflow-hidden bg-neutral-200 mr-3">
                                    <img v-if="author.image" :src="author.image" :alt="author.name" class="w-full h-full object-cover" />
                                    <div v-else class="w-full h-full flex items-center justify-center bg-[#0891b2] text-white font-bold text-sm">
                                        {{ authorInitials }}
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="p-4">
                                <h3 class="text-xl font-bold text-neutral-900 mb-3">
                                    <a
                                        :href="`/post/${post.slug}`"
                                        class="hover:text-[#0891b2] transition-colors"
                                        aria-label="Ler mais sobre este post"
                                    >
                                        {{ post.title }}
                                    </a>
                            ...
                            <div class="flex items-center justify-between px-4 py-3 border-t border-neutral-100 bg-neutral-50">
                                ...
                                <a
                                    :href="`/post/${post.slug}`"
                                    class="px-3 py-1.5 text-[#0891b2] font-medium hover:bg-green-50 rounded-md transition-colors flex items-center"
                                    aria-label="Ler mais sobre este post"
                                >
                                    Ler mais
